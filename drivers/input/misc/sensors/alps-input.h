...
#else
static inline int	hscdtd_get_magnetic_field_data(int *xyz) {xyz[0] = xyz[1] = xyz[2] = 0; return -1;}
static inline void	hscdtd_activate(int flgatm, int flg, int dtime) {return;}
static inline int	hscdtd_self_test_A(void) {return 0;}
static inline int	hscdtd_self_test_B(void) {return 0;}
static inline int	hscdtd_get_hardware_data(int *xyz) {xyz[0] = xyz[1] = xyz[2] = 0; return -1;}
#endif
