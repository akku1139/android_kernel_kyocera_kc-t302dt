...
#if defined (CONFIG_HMX_DB) || defined (TP_IOVCC_1P8V)
...
#ifdef TP_IOVCC_1P8V
struct tp_regulator{
	struct regulator *iovcc; 	/* For iovcc_1P8V */
	char vreg_name[32];
};
#endif
...
struct himax_i2c_platform_data {
	...
	int gpio_fw;
	int gpio_3v3_en;
    int gpio_3v3_lcd_tp_shared_3v3_en;
	int (*power)(int on);
	void (*reset)(void);
...
extern void himax_vdd_enable(int pinnum, int enable);
